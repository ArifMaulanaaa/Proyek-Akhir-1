...
include 'koneksi.php';
  ...
  if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM xboxx WHERE id='$id'";
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!count($data)) {
          echo "<script>alert('Data tidak ditemukan pada database');window.location='halaman_xbx.php';</script>";
       }
  } else {
    // apabila tidak ada data GET id pada akan di redirect ke index.php
    echo "<script>alert('Masukkan data id.');window.location='halaman_xbx.php';</script>";
  }         
  ?>
<!DOCTYPE html>
<html>
  <head>
    <title>Halaman Edit - Xbox X</title>
  ...
  <body>
      ...
      <center>
      <form method="POST" action="proses_edit_xbx.php" enctype="multipart/form-data" >
      <section class="base">
