...
<head>
    ...
    <title>Arif Game Shop - Xbox One</title>
...
<body>
  <style>
    body{
      background-image: url(assets/imgs/bgxb1.png);
    }
  </style>
    <!--Navbar-->
    <nav class="navbar navbar-expand-lg bg-dark py-3 fixed-top">
      ...
      <br><br><br><br><br>
      <center><h1>Data Produk Xbox One</h1><center>
      <center><a class="tambah" href="halaman_tambah_xb1.php"><button>+ &nbsp;Tambah Produk</button></a><center>
      <hr>
    <br/>
    <table>
      <thead>
    ...
    <?php
      ...
      $query = "SELECT * FROM xbox1 ORDER BY id ASC";
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_xb1.php?id=<?php echo $row['id']; ?>">Edit</a> |
              <a href="hapus_xb1.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
