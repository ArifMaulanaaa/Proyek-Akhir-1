...
<head>
    ...
    <title>Arif Game Shop - Xbox X</title>
...
<body>
  <style>
    body{
      background-image: url(assets/imgs/xbx.jpg);
    ...
    <nav class="navbar navbar-expand-lg bg-dark py-3 fixed-top">
      ...
      <br><br><br><br><br>
      <center><h1>Data Produk Xbox series X</h1><center>
      <center><a class="tambah" href="halaman_tambah_xbx.php"><button>+ &nbsp;Tambah Produk</button></a><center>
      <hr>
    <br/>
    <table>
      <thead>
    ...
    <?php
      ...
      $query = "SELECT * FROM xboxx ORDER BY id ASC";
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_xbx.php?id=<?php echo $row['id']; ?>">Edit</a> |
              <a href="hapus_xbx.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
