...
<head>
    ...
    <title>Arif Game Shop - PS5</title>
...
<body>
  <style>
    body{
      background-image: url(assets/imgs/bgpps5.jpg);
    ...
    <nav class="navbar navbar-expand-lg bg-dark py-3 fixed-top">
      ...
      <br><br><br><br><br>
      <center><h1>Data Produk PS5</h1><center>
      <center><a class="tambah" href="halaman_tambah_ps5.php"><button>+ &nbsp;Tambah Produk</button></a><center>
      <hr>
    <br/>
    <table>
      <thead>
    ...
    <?php
      ...
      $query = "SELECT * FROM ps5 ORDER BY id ASC";
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_ps5.php?id=<?php echo $row['id']; ?>">Edit</a> |
              <a href="hapus_ps5.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
