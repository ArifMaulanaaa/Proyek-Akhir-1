...
<head>
    ...
    <title>Arif Game Shop - Nintendo</title>
...
<body>
  <style>
    body{
      background-image: url(assets/imgs/bgntt.jpg);
    ...
    <nav class="navbar navbar-expand-lg bg-dark py-3 fixed-top">
      ...
      <br><br><br><br><br>
      <center><h1>Data Produk Nintendo</h1><center>
      <center><a class="tambah" href="halaman_tambah_nt.php"><button>+ &nbsp;Tambah Produk</button></a><center>
      <hr>
    <br/>
    <table>
      <thead>
    ...
    <?php
      ...
      ?>
       <tr>
          ...
          <td>
              <a href="edit_nt.php?id=<?php echo $row['id']; ?>">Edit</a> |
              <a href="hapus_nt.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">Hapus</a>
          </td>
      </tr>
