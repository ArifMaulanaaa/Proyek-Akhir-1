  ...
  if($gambar_game != "") {
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true)  {
                  move_uploaded_file($file_tmp, 'assets/imgs/'.$nama_gambar_baru); //memindah file gambar ke folder gambar
                   ...
                   $query  = "UPDATE xboxx SET nama_game = '$nama_game', deskripsi = '$deskripsi', kategori = '$kategori', harga = '$harga', gambar_game = '$nama_gambar_baru'";
                    $query .= "WHERE id = '$id'";
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil diubah.');window.location='halaman_xbx.php';</script>";
                    }
              } else {     
      ...
      // jalankan query UPDATE berdasarkan ID yang produknya kita edit
      $query  = "UPDATE xboxx SET nama_game = '$nama_game', deskripsi = '$deskripsi', kategori = '$kategori', harga = '$harga'";
      $query .= "WHERE id = '$id'";
      $result = mysqli_query($koneksi, $query);
      // periska query apakah ada error
      if(!$result){
